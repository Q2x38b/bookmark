...
export default function SignUp() {
  ...
  // Auto-focus code input when entering verification
  useEffect(() => {
        ...
        >
          ...
          <form onSubmit={handleVerification} className="space-y-4">
            <div className="space-y-1.5">
              <Label htmlFor="code" className="text-sm sr-only">Verification code</Label>
              <Input
                ref={codeInputRef}
                id="code"
                type="text"
          ...
          <p className="mt-4 text-center text-sm text-muted-foreground">
            ...
            <button
              ...
              className="text-foreground underline underline-offset-2 hover:no-underline disabled:opacity-50"
            >
